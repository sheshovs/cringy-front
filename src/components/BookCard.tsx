	...
	switch (pattern) {
		...
		case "plants":
			return (
				...
				>
					...
					/>
					<path
						d="M12,14 C8,9 3,11 5,15 C7,19 12,17 12,14"
						fill="white"
					/>
					<path
						d="M12,14 C16,9 21,11 19,15 C17,19 12,17 12,14"
						fill="white"
					/>
				</pattern>
			)
		case "stars":
			return (
				...
				>
					<path
						d="M10,3 L11.5,8 L16.5,8 L12.5,11 L14,16 L10,13 L6,16 L7.5,11 L3.5,8 L8.5,8 Z"
						fill="white"
					/>
				</pattern>
			)
		...
		case "butterflies":
			return (
				...
				>
					<path
						d="M14,11 C10,5 3,6 4,10 C5,13 10,12 14,11Z"
						fill="white"
					/>
					<path
						d="M14,11 C18,5 25,6 24,10 C23,13 18,12 14,11Z"
						fill="white"
					/>
					<path
						d="M14,11 C9,14 5,18 7,21 C9,22 13,17 14,11Z"
						fill="white"
					/>
					<path
						d="M14,11 C19,14 23,18 21,21 C19,22 15,17 14,11Z"
						fill="white"
					/>
				</pattern>
			)
			...
			>
				...
				>
					...
					<div
						...
						style={{
							width: "140px",
							height: "200px",
							background: `linear-gradient(135deg, ${palette.cover} -20%, ${palette.spine} 100%)`,
							boxShadow: `rgba(0, 0, 0, 0.2) 3px 3px 5px`,
						}}
					>
				...
				<div className="mt-3 text-center">
					...
					<p className="text-xs text-[var(--color-ink-light)]">
						{book._count?.readings ?? 0}{" "}
						{book._count?.readings === 1 ? "lectura" : "lecturas"}
					</p>
				</div>
			</div>
		</Link>
